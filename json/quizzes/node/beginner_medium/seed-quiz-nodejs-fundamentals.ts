...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      ...
      description: 'Перевірте свої знання базових концепцій Node.js: event loop, модулі, асинхронність, Express.js, тестування та деплой.',
    },
    en: {
      title: 'Node.js Fundamentals',
      description: 'Test your knowledge of Node.js basics: event loop, modules, asynchronicity, Express.js, testing, and deployment.',
    },
    pl: {
      title: 'Podstawy Node.js',
      description: 'Sprawdź swoją wiedzę o podstawach Node.js: event loop, moduły, asynchroniczność, Express.js, testowanie i deployment.',
    },
  },
};
