...
export const MONO_WEBHOOK_ATOMIC_UPDATE_FAILED =
  'MONO_WEBHOOK_ATOMIC_UPDATE_FAILED' as const;
export const MONO_WEBHOOK_UNKNOWN_STATUS =
  'MONO_WEBHOOK_UNKNOWN_STATUS' as const;
export const MONO_WEBHOOK_RESTOCK_FAILED =
  'MONO_WEBHOOK_RESTOCK_FAILED' as const;
...
export const MONO_LOG_CODES = {
  ...
  WEBHOOK_ATOMIC_UPDATE_FAILED: MONO_WEBHOOK_ATOMIC_UPDATE_FAILED,
  WEBHOOK_UNKNOWN_STATUS: MONO_WEBHOOK_UNKNOWN_STATUS,
  WEBHOOK_RESTOCK_FAILED: MONO_WEBHOOK_RESTOCK_FAILED,
} as const;
