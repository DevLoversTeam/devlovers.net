...
export function GitHubStarButton({ className = '' }: GitHubStarButtonProps) {
  ...
  return (
    <a
      ...
      className={`group bg-foreground text-background dark:bg-foreground dark:text-background border-border relative hidden items-center overflow-hidden rounded-lg border px-3 py-2 text-sm font-medium shadow-sm transition-all duration-200 hover:opacity-90 lg:inline-flex ${className} `}
    >
      <svg
        viewBox="0 0 16 16"
      ...
      <span className="ml-2 flex items-center gap-0.5">
        ...
        <Star
          className="h-4 w-4 flex-shrink-0 transition-all duration-300 group-hover:rotate-12 group-hover:text-yellow-400 group-hover:drop-shadow-[0_0_6px_rgba(250,204,21,0.5)]"
          fill="currentColor"
          aria-hidden="true"
        />
      </span>
