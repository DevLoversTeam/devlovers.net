    ...
    <section className={cardStyles} aria-labelledby="heatmap-heading">
      <div className="flex h-full flex-col">
        <div className="mb-4 flex w-full min-w-0 flex-row items-start justify-between gap-3 sm:mb-6 sm:items-center sm:gap-4">
          ...
          <div className="flex shrink-0 flex-col items-end gap-2 sm:flex-row sm:items-center">
            {currentStreak !== undefined && currentStreak > 0 && (
              <span className="hidden h-[22px] items-center gap-1.5 rounded-full border border-orange-500/20 bg-orange-500/10 px-2 py-0.5 text-[10px] font-bold tracking-wide text-orange-600 sm:inline-flex sm:h-auto sm:px-2.5 sm:py-1 sm:text-[11px] dark:bg-orange-500/20 dark:text-orange-400">
            ...
            <div className="relative z-20" ref={dropdownRef}>
              ...
              >
                <span className="hidden min-w-[70px] text-center sm:block">
        ...
        <div className="relative -mb-2 flex w-full flex-1 flex-col justify-center">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 flex w-[44px] flex-col justify-center pb-1">
        ...
        <AnimatePresence>
          {tooltip && (
            ...
            >
              <div className="min-w-[110px] rounded-xl bg-gray-900 px-3 py-2 text-center shadow-xl shadow-black/30 dark:bg-white">
          ...
          <div className="flex flex-wrap items-center gap-3 text-gray-400 dark:text-gray-500">
            {totalActiveDays > 0 && (
              <span className="flex items-center gap-1">
                ...
                <span>
                  {t('heatmapActiveDays', { count: totalActiveDays })}
                </span>
              </span>
            )}
          </div>
