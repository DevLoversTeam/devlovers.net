    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-2 flex items-center gap-2">
          <span className={cn("text-sm font-semibold", product.badge === "SALE" ? "text-accent" : "text-foreground")}>
        ...
        {!product.inStock && <p className="mt-2 text-xs text-muted-foreground">Sold out</p>}
      </div>
    </Link>
  )
}
