  ...
  return (
    <div className="w-full mt-16 flex flex-col items-center">
      <div className="mb-4 opacity-100">
          <GradientBadge icon={Sparkles} text="Latest Contributors" />
      </div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="group relative flex items-center p-2 rounded-full border border-gray-200 dark:border-white/10 bg-white/10 dark:bg-neutral-900/10 backdrop-blur-xl shadow-sm hover:shadow-lg hover:border-[#1e5eff]/20 dark:hover:border-[#ff2d55]/20 transition-all duration-300"
      >
      ...
      <p className="mt-4 text-[10px] text-gray-500 dark:text-neutral-500 font-mono">
        ...
        <div className={cn(
            ...
            {sponsor.tierColor === 'gold' && (
                 <div className="absolute inset-0 bg-black/10 flex items-center justify-center opacity-0 group-hover/avatar:opacity-100 transition-opacity">
                    <Crown size={12} className="text-white fill-white" aria-label="Gold Tier Sponsor" />
                 </div>
            )}
        </div>
