        ...
        <section className="w-full py-20 lg:py-28 relative overflow-hidden bg-gray-50 dark:bg-transparent" aria-labelledby="pricing-heading">
            ...
            <div className="container-main relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 max-w-4xl mx-auto mb-6">
                    ...
                    >
                        <div className="mb-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t("junior.title")}</h3>
                            <p className="text-sm text-gray-600 dark:text-neutral-400">{t("junior.description")}</p>
                        </div>
                        <div className="mb-8">
                            <span className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white">{t("junior.price")}</span>
                            <span className="text-gray-500 dark:text-neutral-500 font-mono text-sm ml-2">{t("junior.period")}</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-neutral-500 dark:text-neutral-400">{t("hero.description")}</p>
                        </div>
                        <div className="mb-8">
                            <span className="text-4xl lg:text-5xl font-black text-[#1e5eff] dark:text-[#ff2d55]">{t("hero.price")}</span>
                            <span className="text-neutral-500 font-mono text-sm ml-2">{t("hero.period")}</span>
                        </div>
                        ...
                        >
                            {t("hero.cta")} <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                        </Link>
                    </motion.div>
