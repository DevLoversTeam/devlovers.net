            ...
            >
              ...
              {showCorrect && (
                <span className="text-sm font-medium text-green-600 dark:text-green-400">
                  <Check className="inline h-4 w-4" aria-hidden="true"/> {t('correct')}
                </span>
              )}
              {showIncorrect && (
                <span className="text-sm font-medium text-red-600 dark:text-red-400">
                  <X className="inline h-4 w-4" aria-hidden="true"/> {t('incorrect')}
                </span>
              )}
            </label>
          );
      ...
      {isRevealed && !isCorrectAnswer && (
        ...
        >
          <div className="flex items-start gap-3">
            <Lightbulb className="h-6 w-6 flex-shrink-0 text-amber-500" aria-hidden="true" />
