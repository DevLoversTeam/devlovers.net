  ...
  function InteractiveCTAButton(props, forwardedRef) {
    ...
    return (
      ...
      >
          ...
          <span className="relative z-10 flex items-center justify-center gap-2 h-5 min-w-[100px] overflow-hidden">
             <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                    ...
                    className="block whitespace-nowrap text-center origin-center"
                >
                    {currentText}
                </motion.span>
             </AnimatePresence>
