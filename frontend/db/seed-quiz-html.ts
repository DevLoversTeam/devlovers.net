...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      title: 'Основи HTML',
      description:
        'Перевірте свої знання HTML: структура документа, теги, атрибути, форми, семантична розмітка та доступність.',
    },
    en: {
      title: 'HTML Fundamentals',
      description:
        'Test your knowledge of HTML: document structure, tags, attributes, forms, semantic markup and accessibility.',
    },
    pl: {
      title: 'Podstawy HTML',
      description:
        'Sprawdź swoją wiedzę o HTML: struktura dokumentu, tagi, atrybuty, formularze, semantyczne znaczniki i dostępność.',
    },
  },
};
...
async function loadQuestions(partNumber: number): Promise<QuestionData[]> {
  const partPath = join(
    ...
    'html',
    'fundamentals',
    `html-quiz-part${partNumber}.json`
  );
