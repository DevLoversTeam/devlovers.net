...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      ...
      description: 'Поглиблені концепції Angular: lifecycle hooks, DI декоратори, NgRx, кастомні директиви, SSR, Signals, OnPush та оптимізація продуктивності.',
    },
    en: {
      title: 'Angular Advanced',
      description: 'Advanced Angular concepts: lifecycle hooks, DI decorators, NgRx, custom directives, SSR, Signals, OnPush and performance optimization.',
    },
    pl: {
      title: 'Angular Advanced',
      description: 'Zaawansowane koncepcje Angular: lifecycle hooks, dekoratory DI, NgRx, niestandardowe dyrektywy, SSR, Signals, OnPush i optymalizacja wydajności.',
    },
  },
};
