...
async function main() {
  ...
  const demoUsers = [
    ...
    },
    {
      ...
      points: 950, // 3rd place
    },
    {
      id: 'demo_4',
      name: 'BugHunter',
      email: 'bug@demo.com',
      points: 800, // 4th place (List)
    },
    {
      id: 'demo_5',
      name: 'DevOps_Guru',
      email: 'ops@demo.com',
      points: 600, // 5th place (List)
    },
  ];
  ...
  await db
    ...
    .onConflictDoUpdate({
      target: users.email,
      set: { points: sql`excluded.points` }, // Оновлює бали, якщо юзер вже є
    });
