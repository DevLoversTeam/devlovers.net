// scripts/seed-quiz-react.ts
  // Seed script for React quiz with multilingual support (uk, en, pl)
  // Run: npx tsx db/seed-quiz-react.ts
  ...
  const quizTranslationsData: Record<Locale, { title: string; description: string }>
  = {
    uk: {
      title: 'Основи React',
      description: 'Перевірте свої знання базових концепцій React: компоненти,Virtual DOM, JSX, props та state.',
    },
    en: {
      title: 'React Fundamentals',
      description: 'Test your knowledge of React basics: components, Virtual DOM,JSX, props and state.',
    },
    pl: {
      title: 'Podstawy React',
      description: 'Sprawdź swoją wiedzę o podstawach React: komponenty, Virtual DOM,JSX, props i state.',
    },
  };
  ...
  const questionsData: QuizQuestionSeed[] = [
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'Коли щось змінюється, React спочатку оновлюєвіртуальну версію' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Порівнює її з попередньою (це називається"diffing")' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Вносить лише мінімальні зміни в реальний DOM'
  }],
                },
              ],
            },
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'When something changes, React first updates thevirtual version' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Compares it with the previous one (this iscalled "diffing")' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Makes only minimal changes to the real DOM' }],
                },
              ],
            },
            {
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'Gdy coś się zmienia, React najpierw aktualizuje wirtualną wersję' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Porównuje ją z poprzednią (nazywa się to"diffing")' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Wprowadza tylko minimalne zmiany do prawdziwego DOM' }],
                },
              ],
            },
            {
    ...
    // -------------------------------------------------------------------------
    // Question 4: useEffect empty dependency array
    // -------------------------------------------------------------------------
    {
      displayOrder: 4,
      difficulty: 'medium',
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'Порожній масив каже React: "цей ефект незалежить від жодних значень"' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Без масиву — ефект запускається після кожногорендеру' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'З залежностями [a, b] — ефект запускається при зміні a або b' }],
                },
              ],
            },
          ],
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'Empty array tells React: "this effect doesn\'tdepend on any values"' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Without array — effect runs after every render'
   }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'With dependencies [a, b] — effect runs when aor b changes' }],
                },
              ],
            },
          ],
          ...
          explanation: [
            ...
            },
            {
              ...
              children: [
                {
                  type: 'listItem',
                  children: [{ text: 'Pusta tablica mówi React: "ten efekt nie zależy od żadnych wartości"' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Bez tablicy — efekt uruchamia się po każdymrenderze' }],
                },
                {
                  type: 'listItem',
                  children: [{ text: 'Z zależnościami [a, b] — efekt uruchamia sięgdy zmienia się a lub b' }],
                },
              ],
            },
          ],
  ...
  async function seedReactQuiz() {
    ...
    try {
      ...
      // 3. Create questions, content, answers
      ...
      for (const question of questionsData) {
        ...
        // 3.2 Insert question content for each locale
        for (const locale of locales) {
        ...
        for (const answer of question.answers) {
          ...
          // 3.4 Insert answer translations
          for (const locale of locales) {
