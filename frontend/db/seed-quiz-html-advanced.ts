...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      ...
      description:
        'Перевірте поглиблені знання HTML: Web Components, Shadow DOM, API браузера, доступність, SEO, продуктивність та сучасні можливості.',
    },
    en: {
      title: 'HTML Advanced',
      description:
        'Test your advanced HTML knowledge: Web Components, Shadow DOM, browser APIs, accessibility, SEO, performance and modern features.',
    },
    pl: {
      title: 'HTML Zaawansowany',
      description:
        'Sprawdź zaawansowaną wiedzę o HTML: Web Components, Shadow DOM, API przeglądarki, dostępność, SEO, wydajność i nowoczesne funkcje.',
    },
  },
};
...
async function loadQuestions(partNumber: number): Promise<QuestionData[]> {
  const partPath = join(
    ...
    'html',
    'advanced',
    `html-advanced-quiz-part${partNumber}.json`
  );
