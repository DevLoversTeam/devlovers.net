...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      title: 'Основи CSS',
      description:
        'Перевірте свої знання базових концепцій CSS: селектори, блокова модель, Flexbox, Grid, позиціонування, анімації та адаптивний дизайн.',
    },
    en: {
      title: 'CSS Fundamentals',
      description:
        'Test your knowledge of CSS basics: selectors, box model, Flexbox, Grid, positioning, animations, and responsive design.',
    },
    pl: {
      title: 'Podstawy CSS',
      description:
        'Sprawdź swoją wiedzę o podstawach CSS: selektory, model pudełkowy, Flexbox, Grid, pozycjonowanie, animacje i responsywny design.',
    },
  },
};
