...
const QUIZ_METADATA = {
  ...
  translations: {
    uk: {
      ...
      description:
        'Перевірте свої знання базових концепцій JavaScript: змінні, типи даних, функції, асинхронність, прототипи та ES6+ можливості.',
    },
    en: {
      title: 'JavaScript Fundamentals',
      description:
        'Test your knowledge of JavaScript basics: variables, data types, functions, asynchronicity, prototypes and ES6+ features.',
    },
    pl: {
      title: 'Podstawy JavaScript',
      description:
        'Sprawdź swoją wiedzę o podstawach JavaScript: zmienne, typy danych, funkcje, asynchroniczność, prototypy i funkcje ES6+.',
    },
  },
};
...
async function loadQuestions(partNumber: number): Promise<QuestionData[]> {
  const partPath = join(
    process.cwd(),
    'data',
    `javascript-quiz-part${partNumber}.json`
  );
